...
BetterVibe's AWS scaffold (`backend/`, `infra/`, `frontend/`, `aws/`, `admin/`) was
...
BetterVibe's product, data model (16-table multi-tenant schema with an application-enforced
...
design system (see `DESIGN.md`) are original to this project. BetterVibe forks gatsby's
